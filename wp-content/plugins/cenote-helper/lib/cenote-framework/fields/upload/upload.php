 ...
 *
 */
class CENOTEFramework_Option_upload extends CENOTEFramework_Options {
  ...
  public function output() {
    ...
    echo '<a href="#" class="button cenote-add" data-frame-title="'. $frame_title .'" data-upload-type="'. $upload_type .'" data-insert-title="'. $insert_title .'">'. $button_title .'</a>';
